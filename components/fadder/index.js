      ...
      <div className="component fadder-content">
        <div className="fadder-description">
          ...
          <p>
            ...
            i det supre fadderopplegget vårt! Du trenger ikke å melde deg på fadderukene, så lenge du kommer på immatrikuleringen. 
            Dersom du ikke har mulighet til å møte opp, kan du sende oss en mail så fikser vi deg en faddergruppe!
          </p>
